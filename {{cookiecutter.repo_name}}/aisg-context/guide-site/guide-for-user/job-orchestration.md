...
[this section](./mlops-components-platform#polyaxon-dashboard)
...
1. Ensure that the Polyaxon job for model experimentation is configured
   ...
   See
   ["Secrets & Credentials on Kubernetes"](./mlops-components-platform#secrets-credentials-on-kubernetes)
   on how to do this.
